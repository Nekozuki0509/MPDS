        ...
        new Thread(() -> {
            ...
            while (true) {
                try {
                    ...
                    ondisconnectstatement.setString(11, player.getInventory().offHand.getFirst().isEmpty() ? "" : ItemStack.CODEC.encodeStart(wrappedOps, player.getInventory().offHand.getFirst()).resultOrPartial(LOGGER::error).orElseThrow().toString());
